...
class UniControlNet(LatentDiffusion):
    ...
    def apply_model(self, x_noisy, t, cond, global_strength=2, *args, **kwargs):
    ...
    @torch.no_grad()
    def log_images(self, batch, N=4, n_row=2, sample=False, ddim_steps=30, ddim_eta=0.0, plot_denoise_rows=False,
